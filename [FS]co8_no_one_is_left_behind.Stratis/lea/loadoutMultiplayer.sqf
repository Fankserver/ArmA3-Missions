...
removeBackpack tl1;
removeVest tl1;
if (tsk0 == false) then {removeGoggles tl1};
...
(backpackContainer tl1) additemcargoGlobal ["x39_morphine",3];
(backpackContainer tl1) additemcargoGlobal ["x39_epinephrine",3];
(backpackContainer tl1) additemcargoGlobal ["x39_tourniquet",2];
...
removeBackpack g5;
removeVest g5;
if (tsk0 == false) then {removeGoggles g5};
...
(backpackContainer g5) additemcargoGlobal ["x39_morphine",3];
(backpackContainer g5) additemcargoGlobal ["x39_epinephrine",3];
(backpackContainer g5) additemcargoGlobal ["x39_tourniquet",2];
...
removeBackpack gl2;
removeVest gl2;
if (tsk0 == false) then {removeGoggles g12};
...
(vestContainer gl2) additemcargoGlobal ["x39_morphine",3];
(vestContainer gl2) additemcargoGlobal ["x39_epinephrine",3];
(vestContainer gl2) additemcargoGlobal ["x39_tourniquet",2];
...
removeBackpack g4;
removeVest g4;
if (tsk0 == false) then {removeGoggles g4};
...
(vestContainer g4) additemcargoGlobal ["x39_morphine",3];
(vestContainer g4) additemcargoGlobal ["x39_epinephrine",3];
(vestContainer g4) additemcargoGlobal ["x39_tourniquet",2];
...
removeBackpack g7;
removeVest g7;
if (tsk0 == false) then {removeGoggles g7};
...
(vestContainer g7) additemcargoGlobal ["x39_tourniquet",2];
...
removeBackpack g3;
removeVest g3;
if (tsk0 == false) then {removeGoggles g3};
...
(vestContainer g3) additemcargoGlobal ["x39_tourniquet",2];
...
removeBackpack g2;
removeVest g2;
if (tsk0 == false) then {removeGoggles g2};
...
(backpackContainer g2) additemcargoGlobal ["x39_morphine",3];
(backpackContainer g2) additemcargoGlobal ["x39_epinephrine",3];
(backpackContainer g2) additemcargoGlobal ["x39_tourniquet",2];
...
if (!isNil "playerCaptive") then {
	if (player == playerCaptive) exitwith {
		if (tsk1 == true) then {
			...
			if (tsk0 == false) then {removeGoggles playerCaptive};
			playerCaptive addWeapon "ItemMap";
			playerCaptive addWeapon "ItemWatch";
			playerCaptive addWeapon "ItemCompass";
			playerCaptive addWeapon "ItemGPS";
			playerCaptive addWeapon "H_HelmetLeaderO_ocamo";
			playerCaptive addBackpack "B_TacticalPack_blk";
			(backpackContainer playerCaptive) addmagazinecargoGlobal ["100Rnd_65x39_caseless_mag_Tracer",1];
			playerCaptive addWeapon "arifle_MX_SW_Black_F";
			removeBackpack playerCaptive;
			playerCaptive addPrimaryWeaponItem "acc_pointer_IR";
			playerCaptive addPrimaryWeaponItem "optic_Aco";
			playerCaptive addBackpack "B_TacticalPack_blk";
			(backpackContainer playerCaptive) addmagazinecargoGlobal ["9Rnd_45ACP_Mag",1];
			playerCaptive addWeapon "hgun_ACPC2_F";
			removeBackpack playerCaptive;
			playerCaptive addBackpack "B_Carryall_oli";
			clearItemCargoGlobal (backpackContainer playerCaptive);
			clearMagazineCargoGlobal (backpackContainer playerCaptive);
			clearWeaponCargoGlobal (backpackContainer playerCaptive);
			(backpackContainer playerCaptive) additemcargoGlobal ["x39_bandage",5];
			(backpackContainer playerCaptive) additemcargoGlobal ["x39_morphine",3];
			(backpackContainer playerCaptive) additemcargoGlobal ["x39_epinephrine",3];
			(backpackContainer playerCaptive) additemcargoGlobal ["x39_tourniquet",2];
			(backpackContainer playerCaptive) addmagazinecargoGlobal ["100Rnd_65x39_caseless_mag_Tracer",8];
			playerCaptive addVest "V_PlateCarrier1_blk";
			clearItemCargoGlobal (vestContainer playerCaptive);
			clearMagazineCargoGlobal (vestContainer playerCaptive);
			clearWeaponCargoGlobal (vestContainer playerCaptive);
			(vestContainer playerCaptive) additemcargoGlobal ["FirstAidKit",1];
			(vestContainer playerCaptive) addmagazinecargoGlobal ["9Rnd_45ACP_Mag",1];
			(vestContainer playerCaptive) addmagazinecargoGlobal ["100Rnd_65x39_caseless_mag_Tracer",1];
			playerCaptive addItemToVest "HandGrenade";
			playerCaptive addItemToVest "HandGrenade";
			...
			(uniformContainer playerCaptive) addmagazinecargoGlobal ["9Rnd_45ACP_Mag",3];
			playerCaptive addWeapon "tf_anprc152";
			playerCaptive selectWeapon (primaryWeapon playerCaptive);
		} else {		
			removeallweapons playerCaptive;
			removeallassigneditems playerCaptive;
			removeHeadgear playerCaptive;
