...
* Version: 2.0.17
* Wed Jun 04 00:14:12 CEST 2014
* Mission file name: Stratis%201.Stratis
* Mission name: Stratis%201.Stratis
* Required mods:
* + ArmA 3
* + TFAR
* + XMedSys
...
//Empty, nothing to do. unit bonusCargo
//Empty, nothing to do. unit bonusCargo_1
...
tl1 addWeapon "arifle_MXM_Black_F";
removeBackpack tl1;
tl1 addPrimaryWeaponItem "acc_pointer_IR";
tl1 addPrimaryWeaponItem "optic_Holosight";
tl1 addBackpack "B_TacticalPack_blk";
...
(backpackContainer g5) addmagazinecargoGlobal ["30Rnd_65x39_caseless_mag",1];
g5 addWeapon "arifle_MX_GL_Black_F";
removeBackpack g5;
g5 addPrimaryWeaponItem "acc_pointer_IR";
g5 addPrimaryWeaponItem "optic_Holosight";
g5 addBackpack "B_TacticalPack_blk";
...
(backpackContainer g4) addmagazinecargoGlobal ["30Rnd_65x39_caseless_mag",1];
g4 addWeapon "arifle_MX_F";
removeBackpack g4;
g4 addPrimaryWeaponItem "acc_pointer_IR";
g4 addPrimaryWeaponItem "optic_Holosight";
g4 addBackpack "B_TacticalPack_blk";
(backpackContainer g4) addmagazinecargoGlobal ["9Rnd_45ACP_Mag",1];
g4 addWeapon "hgun_ACPC2_F";
removeBackpack g4;
g4 addBackpack "B_Carryall_oli";
...
(backpackContainer g7) addmagazinecargoGlobal ["30Rnd_65x39_caseless_mag",1];
g7 addWeapon "arifle_MX_F";
removeBackpack g7;
g7 addPrimaryWeaponItem "acc_pointer_IR";
g7 addPrimaryWeaponItem "optic_Holosight";
g7 addBackpack "B_TacticalPack_blk";
...
(backpackContainer g7) additemcargoGlobal ["x39_bandage",15];
(backpackContainer g7) additemcargoGlobal ["x39_morphine",15];
(backpackContainer g7) additemcargoGlobal ["x39_bloodbag",2];
(backpackContainer g7) additemcargoGlobal ["x39_epinephrine",15];
...
(vestContainer g7) addmagazinecargoGlobal ["30Rnd_65x39_caseless_mag_Tracer",5];
...
(backpackContainer g3) addmagazinecargoGlobal ["30Rnd_65x39_caseless_mag",1];
g3 addWeapon "arifle_MX_F";
removeBackpack g3;
g3 addPrimaryWeaponItem "acc_pointer_IR";
g3 addPrimaryWeaponItem "optic_Holosight";
g3 addBackpack "B_TacticalPack_blk";
...
(backpackContainer g3) additemcargoGlobal ["x39_bandage",15];
(backpackContainer g3) additemcargoGlobal ["x39_morphine",15];
(backpackContainer g3) additemcargoGlobal ["x39_bloodbag",2];
(backpackContainer g3) additemcargoGlobal ["x39_epinephrine",15];
...
(vestContainer g3) addmagazinecargoGlobal ["30Rnd_65x39_caseless_mag_Tracer",5];
...
g2 addPrimaryWeaponItem "optic_Holosight";
g2 addBackpack "B_TacticalPack_blk";
...
if (!isNil "maxPat2") then {
removeallweapons maxPat2;
removeallassigneditems maxPat2;
removeHeadgear maxPat2;
removeUniform maxPat2;
removeBackpack maxPat2;
removeVest maxPat2;

if (count weapons maxPat2 > 0) then {
  private['_type', '_muzzles'];
  _type = ((weapons maxPat2) select 0);
  _muzzles = getArray(configFile >>"cfgWeapons">> _type >>"muzzles");
  if (count _muzzles > 1) then {
     maxPat2 selectWeapon (_muzzles select 0);
  }
  else {
     maxPat2 selectWeapon _type;
  };
};
};
...
if (!isNil "Informant1") then {
removeallweapons Informant1;
removeallassigneditems Informant1;
removeHeadgear Informant1;
removeUniform Informant1;
removeBackpack Informant1;
removeVest Informant1;

if (count weapons Informant1 > 0) then {
  private['_type', '_muzzles'];
  _type = ((weapons Informant1) select 0);
  _muzzles = getArray(configFile >>"cfgWeapons">> _type >>"muzzles");
  if (count _muzzles > 1) then {
     Informant1 selectWeapon (_muzzles select 0);
  }
  else {
     Informant1 selectWeapon _type;
  };
};
};

if (!isNil "xyz") then {
removeallweapons xyz;
removeallassigneditems xyz;
removeHeadgear xyz;
removeUniform xyz;
removeBackpack xyz;
removeVest xyz;

if (count weapons xyz > 0) then {
  private['_type', '_muzzles'];
  _type = ((weapons xyz) select 0);
  _muzzles = getArray(configFile >>"cfgWeapons">> _type >>"muzzles");
  if (count _muzzles > 1) then {
     xyz selectWeapon (_muzzles select 0);
  }
  else {
     xyz selectWeapon _type;
  };
};
};

if (!isNil "maxPat2_1") then {
removeallweapons maxPat2_1;
removeallassigneditems maxPat2_1;
removeHeadgear maxPat2_1;
removeUniform maxPat2_1;
removeBackpack maxPat2_1;
removeVest maxPat2_1;

if (count weapons maxPat2_1 > 0) then {
  private['_type', '_muzzles'];
  _type = ((weapons maxPat2_1) select 0);
  _muzzles = getArray(configFile >>"cfgWeapons">> _type >>"muzzles");
  if (count _muzzles > 1) then {
     maxPat2_1 selectWeapon (_muzzles select 0);
  }
  else {
     maxPat2_1 selectWeapon _type;
  };
};
};

if (!isNil "evac") then {
removeallweapons evac;
removeallassigneditems evac;
removeHeadgear evac;
removeUniform evac;
removeBackpack evac;
removeVest evac;

if (count weapons evac > 0) then {
  private['_type', '_muzzles'];
  _type = ((weapons evac) select 0);
  _muzzles = getArray(configFile >>"cfgWeapons">> _type >>"muzzles");
  if (count _muzzles > 1) then {
     evac selectWeapon (_muzzles select 0);
  }
  else {
     evac selectWeapon _type;
  };
};
};

if (!isNil "loot") then {
removeallweapons loot;
removeallassigneditems loot;
removeHeadgear loot;
removeUniform loot;
removeBackpack loot;
removeVest loot;

if (count weapons loot > 0) then {
  private['_type', '_muzzles'];
  _type = ((weapons loot) select 0);
  _muzzles = getArray(configFile >>"cfgWeapons">> _type >>"muzzles");
  if (count _muzzles > 1) then {
     loot selectWeapon (_muzzles select 0);
  }
  else {
     loot selectWeapon _type;
  };
};
};
